...
def obtener_tiempo():
    ...
    # Asegurando que la ventana está visible antes de obtener dimensiones
    x = texto_hora.winfo_height() if texto_hora.winfo_height() > 0 else 20
    t = int((x-5)*0.32) 

    if dia == 'Monday': dia = 'Lunes'
    elif dia == 'Tuesday': dia = 'Martes'
    elif dia == 'Wednesday': dia = 'Miércoles'
    elif dia == 'Thursday': dia = 'Jueves'
    elif dia == 'Friday': dia = 'Viernes'
    elif dia == 'Saturday': dia = 'Sábado'
    elif dia == 'Sunday': dia = 'Domingo'
